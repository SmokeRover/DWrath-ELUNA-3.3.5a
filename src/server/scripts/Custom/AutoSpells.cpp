/*
A port of mod-learn-spells from azerothcore by conan513
https://github.com/azerothcore/mod-learn-spells

Seems to work fine, I've done nothing but change a couple of minor differences in wordage between projects
and included SpellMgr.h and DBCStores.cpp

Also cut the auto-appending code from the original script for azerothcore
*/
#include "Chat.h"
#include "Config.h"
