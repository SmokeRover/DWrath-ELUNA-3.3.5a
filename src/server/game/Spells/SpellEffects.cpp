...
void Spell::EffectEnergize(SpellEffIndex effIndex)
{
    ...
    //DWrath edit this corrects rage generation for static incrases EG Bloodrage and Charge.
    //Probably breaking other junk in the process but its fine for now
...
void Spell::EffectCreateTamedPet(SpellEffIndex effIndex)
{
    if (effectHandleMode != SPELL_EFFECT_HANDLE_HIT_TARGET)
        return;
    //DWrath edit, removed check for class
