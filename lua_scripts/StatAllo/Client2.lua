...
fontAttributesPointsLeft:SetSize(150, 5)
fontAttributesPointsLeft:SetPoint("TOPLEFT", 9, -25)
...
function MyHandlers.SetStats(player, left, p1, p2, p3, p4, p5)
    ...
    fontAttributesPointsLeft:SetText("|cFF000000 Point(s) Left: "..left.."|r")
end

_G["CharacterFrame"]:HookScript("OnShow", function(self) 
    frameAttributes:Show()
    frameAttributes:SetPoint("LEFT", _G["CharacterFrame"], "RIGHT", -30, 150)
end)
...
--[[
frameAttributes:RegisterEvent("WORLD_MAP_UPDATE")
local function eventHandler(self, event)
    print("Hello World! Hello "..event)

    local mapButton = CreateFrame("Button", "mapButton", _G["WorldMapFrame"], nil)
    mapButton:SetSize(20, 20)
    mapButton:SetPoint("TOPLEFT", 0, 0)
    mapButton:EnableMouse(true)
    mapButton:SetNormalTexture("Interface/BUTTONS/UI-SpellbookIcon-PrevPage-Up")
    mapButton:SetHighlightTexture("Interface/BUTTONS/UI-Panel-MinimizeButton-Highlight")
    mapButton:SetPushedTexture("Interface/BUTTONS/UI-SpellbookIcon-PrevPage-Down")

    mapButton:SetScript("OnMouseUp", function()
...
frameAttributes:SetScript("OnEvent", eventHandler)
--]]